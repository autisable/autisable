  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="rounded-2xl overflow-hidden mb-8">
        <iframe
          src="https://open.spotify.com/embed/artist/1eyxJ7o9D9CmXYFFBidmLv?utm_source=generator"
          width="100%"
          height="352"
      ...
      <div className="flex justify-center gap-4 mb-8">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#FF0000] hover:bg-[#cc0000] text-white text-sm font-medium rounded-xl transition-colors"
        >
